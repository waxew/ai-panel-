    ...
    <div className="orders-page" dir="rtl">
      ...
      <main>
        <section className="hero">
          <div><small>Commerce Operations</small><h1>سفارش‌ها</h1><p>سفارش‌های واقعی فروشگاه، مشتری، اقلام و وضعیت پردازش. وضعیت پرداخت از این صفحه قابل جعل نیست و فقط توسط جریان پرداخت معتبر تغییر می‌کند.</p></div>
          ...
          <section className="workspace">
            ...
            <article className="detail">
              {!selected ? <div className="empty">یک سفارش را انتخاب کنید.</div> : <>
                ...
                {selected.status === 'AWAITING_PAYMENT' && <p className="warning">این سفارش هنوز پرداخت نشده است. دکمه «پرداخت‌شده» عمداً وجود ندارد؛ تأیید PAID باید از Callback معتبر درگاه پرداخت انجام شود.</p>}
              </>}
            </article>
          </section>
        </>}
